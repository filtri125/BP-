...
/*Query that summarises the total number of ambient waste transactions*/

SELECT COUNT(TransactionID) AS NumberOfWasteTransactions
FROM WBAmbientWaste;

/*Query that summarises the total amount of ambient waste*/

SELECT SUM(AmbientWaste) AS TotalWaste
FROM WBAmbientWaste;

/*Combined query which summarises the total number of ambient waste transactions and the total amount of ambient waste*/
